    ...
    return (
        <Layout>
            <div className=" container mx-auto px-4 py-5 lg:py-8">
                ...
                <div className="top ">
                    {/* main  */}
                    <div className=" bg-[#FCF6F5FF] py-5 rounded-xl border border-[#89ABE3FF]">
                        {/* image  */}
                            ...
                            return (
                               <div key={index} className="">
                                {order.cartItems.map((item,index)=>{
                                    ...
                                    return(
                                        <div key={index} className="mt-5 flex flex-col overflow-hidden rounded-xl border border-[#89ABE3FF] md:flex-row">
                                        {/* main 3  */}
                                        <div className="w-full border-r border-[#89ABE3FF] bg-[#FCF6F5FF] md:max-w-xs">
                                            {/* left  */}
                                            <div className="p-8">
                                                <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-1">
                                                    ...
                                                    <div className="mb-4">
                                                        ...
                                                        <div className="text-sm font-medium text-[#89ABE3FF] first-letter:uppercase">{order.status}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
